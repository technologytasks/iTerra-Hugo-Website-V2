...
heat_battery:
  ...
  flow_body: Solar / Grid Electricity → Ceramic Thermal Storage → Hot Water ·
    Space Heat · Industrial Process Heat
  use_cases:
    - icon: 🏠
      title: Domestic
      body: Hot‑water geysers and residential heat — charged from rooftop solar or the
...
charge:
  ...
  body: >
    ThermoVolt stores electricity as **heat** with near‑100% electricity‑to‑heat
  ...
  cards:
    ...
    - icon: ⚡
      ...
      body: >
        Pakistan has set a target of **60% renewable energy by 2030** — already
...
small_mass:
  ...
  body_1: >
    ...
    mass shrinks, surface area decreases more slowly than volume — so small
    masses at 1,000°C lose heat disproportionately through their surface. The
  ...
  body_2: >
    **ThermoVolt resolves this differently.** Rather than fighting parasitic
    ...
    design. The 1,000°C ceramic core is embedded within the water vessel — so
  ...
  image: /images/whatsapp-image-2026-04-11-at-2.28.28-pm.jpeg
...
field_validation:
  ...
  body: >
    ...
    liters/day** of ~**60°C** hot water, with multi‑day retention from a single
  ...
  field_intro: "Field trials in Gujranwala validate performance under Pakistan's
    demanding climate: 45°C+ ambient temperatures, dust, humidity, and voltage
    fluctuations."
  features:
    - icon: 🌡️
      title: Thermal Mass Core (1,000°C)
      body: Multiple charge/discharge cycles recorded. Core temperature climbs to
        1,000°C+ during charging, holds heat through multi-day discharge without
        supplemental energy.
    - icon: 💧
      title: Water Delivery (60–72°C)
      body: "Water temperatures consistently reach ~60–72°C per cycle — sufficient for
    ...
    - icon: 🧱
      ...
      body: Five-layer insulation stack shows well-controlled heat gradient — minimal
...
safety:
  ...
  body: >
    ...
    stays below 90°C at the water side, with passive and electronic safeguards.
  ...
  features:
    - icon: 🛡️
      ...
      body: Double‑cylinder SS304 water body rated for domestic pressure service, with
        a 3‑bar pressure relief valve (PRV) and temperature control logic to
  ...
  steps:
    ...
    - icon: ⚡
      ...
      text: In grid-connected installations, the controller tracks dynamic tariffs. It
        charges the battery **during low-tariff peak-PV windows** — and stops
        when tariffs rise.
    - icon: 🧱
      label: Thermal Storage
      text: Electricity drives FeCrAl heating elements embedded in the alumina core —
...
industrial:
  ...
  body: Pakistan's industrial sector burns imported gas for heat it could store
    from solar. ThermoVolt replaces the burner — not the factory. Four prominent
